    ...
    if(user.trialUser) {
        ...
        <div class="darkmode-checkbox-container" style="position: fixed; top: 0; left: 0; padding: 5px; font-size: 12px; border-radius:4px; width: 100%;">
            ${  daysRemaining == 0 ? `Trail expired` :
                ...
                <button @click=${navigateToPlan} class="usa-button usa-button--outline" style=" margin-right: 0; font-size: 12px; padding: 5px; max-width: 100px;">Buy full access</button>
        </div>
        `
    }
    return html``;
