...
import { deck as deckPage, home as homePage } from '../../../../routes/navigation/pages'
...
function jumpToDeckCard(){
  deckPage({
    deck: getDeckId(),
    card: window.encodeURIComponent(getActiveCardId())
  })
}
export default () => {
  ...
  <li class="usa-sidenav__item" >
    <a href="#" @click=${jumpToDeckCard}><i class="far fa-edit"></i>&nbsp;&nbsp;Edit</a>
  </li>
    <li class="usa-sidenav__item" >
